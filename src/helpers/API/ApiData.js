...
export const getHttpOptions = (options = defaultHeaders) => {
    ...
    if (options.hasOwnProperty("isAuth") && options.isAuth) {
        ...
        } else if (authUtil.getStoreToken()) { 
            headers["x-auth-owner"] = authUtil.getStoreToken();
        }       
        else if (authUtil.getForgetPassToken()){
            headers["otp-verify-token"] = authUtil.getForgetPassToken();
        }else if (authUtil.getPasswordResetToken()){
            headers["password-reset-token"] = authUtil.getPasswordResetToken();
        }
    }
